...
def load_data():
    ...
    data['SMA9'] = talib.SMA(data['Close'], timeperiod=9)
...
def backtest_strategy(data, connection_range, explosion_range, stop_loss_range, profit_target_range, entry_hour_range):
    ...
    for connection, explosion, stop_loss, profit_target, entry_hour in product(connection_range, explosion_range, stop_loss_range, profit_target_range, entry_hour_range):
        ...
        if num_trades >= 10:
            ...
            losing_trades_streaks = (trade_records_df["PNL"] < 0).astype(int)
...
def main():
    ...
    backtest_strategy(data, connection_range, explosion_range,
                      stop_loss_range, profit_target_range, entry_hour_range)
